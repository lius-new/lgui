...
fn blur_telemetry(index: usize) -> &'static lgui_core::memory::CacheTelemetry {
    static TELEMETRY: OnceLock<[lgui_core::memory::CacheTelemetry; 3]> = OnceLock::new();
    &TELEMETRY.get_or_init(Default::default)[index]
}

thread_local! {
    static BLUR_CACHE: RefCell<lgui_core::memory::LruCache<BlurCacheKey, Vec<u8>>> = RefCell::new(
    ...
    static SOURCE_RASTER_CACHE: RefCell<lgui_core::memory::LruCache<SourceRasterKey, image::RasterImage>> = RefCell::new(
        lgui_core::memory::LruCache::new(
            0,
            lgui_core::memory::ResourceClass::Cache,
    ...
    static BLURRED_SOURCE_CACHE: RefCell<lgui_core::memory::LruCache<BlurredSourceKey, image::RasterImage>> = RefCell::new(
        lgui_core::memory::LruCache::new(
            0,
            lgui_core::memory::ResourceClass::Cache,
...
fn apply_tint(pixels: &mut [u8], color: lgui_core::core::Color, alpha: f32) {
