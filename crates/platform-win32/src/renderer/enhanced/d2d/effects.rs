...
pub(super) fn radial_gradient_stops(
    layer: lgui_core::core::RadialGradientLayer,
...
pub(super) fn polygon_points(path: &UiPath) -> Option<Vec<lgui_core::core::Point>> {
...
pub(super) fn point_in_polygon(x: f32, y: f32, points: &[lgui_core::core::Point]) -> bool {
...
pub(super) fn backdrop_blur_signature(
    rect: UiRect,
    style: lgui_core::core::BackdropBlurStyle,
) -> u64 {
    let mut hasher = DefaultHasher::new();
...
fn hash_point(point: &lgui_core::core::Point, hasher: &mut DefaultHasher) {
