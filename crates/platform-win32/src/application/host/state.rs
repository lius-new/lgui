...
pub(super) struct WindowState {
    ...
    pub(super) renderer_memory: Arc<Mutex<lgui_core::memory::CacheUsage>>,
    ...
    #[cfg(feature = "images-win32")]
    pub(super) image_reachability_scene: Option<lgui_core::core::Scene>,
    pub(super) _renderer_memory_registration: lgui_core::memory::CacheRegistration,
    ...
    pub(super) _component_memory_registration: lgui_core::memory::CacheRegistration,
    pub(super) _host_scene_memory_registration: lgui_core::memory::CacheRegistration,
    pub(super) renderer_factory: Arc<dyn Win32RendererFactory>,
