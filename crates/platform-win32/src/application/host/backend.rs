    ...
    fn run(self, options: WindowOptions, view: AppView, context: ApplicationContext) -> Result<()> {
        ...
        #[cfg(feature = "images-win32")]
        {
            ...
            let registration =
                context
                    .memory()
                    .register(lgui_core::memory::DomainRegistration::new(
                        lgui_core::memory::CacheDomain::DecodedImage,
                        context.memory().next_instance_id(),
                        "application:win32-gdiplus-images",
                        lgui_core::memory::CacheAdapter::managed(
                            super::super::super::decoded_image_cache_usage,
                            move |request| {
                                let before = super::super::super::decoded_image_cache_usage()
                                    .resident_bytes();
        ...
        #[cfg(feature = "renderer-d2d")]
        {
            ...
            let registration =
                context
                    .memory()
                    .register(lgui_core::memory::DomainRegistration::new(
                        lgui_core::memory::CacheDomain::Blur,
                        context.memory().next_instance_id(),
                        ...
                        lgui_core::memory::CacheAdapter::managed(
                            ...
                            move |budget| {
                                budget_dispatcher.post(move || {
                                    super::super::super::enhanced::blur::set_blur_cache_budget(
                                        budget,
                                    );
                                });
                            },
        ...
        #[cfg(feature = "advanced-rendering")]
        {
            ...
            let registration = context
                .memory()
                .register(lgui_core::memory::DomainRegistration::new(
                    lgui_core::memory::CacheDomain::StaticLayer,
                    context.memory().next_instance_id(),
        ...
        #[cfg(feature = "advanced-rendering")]
        let _render_cache = lgui_core::backend::install_render_cache(
            super::super::super::enhanced::portable_render_cache_handle(),
        );
        super::super::super::set_ui_font_families(lgui_core::backend::configured_font_families(
            &context,
        ));
        let _font_environment = lgui_core::backend::install_font_environment(
            &context,
        ...
        #[cfg(feature = "svg")]
        {
            ...
            let registration =
                context
                    .memory()
                    .register(lgui_core::memory::DomainRegistration::new(
                        lgui_core::memory::CacheDomain::Svg,
                        context.memory().next_instance_id(),
                        "application:win32-svg",
                        lgui_core::memory::CacheAdapter::managed(
                            super::super::super::svg::svg_bitmap_cache_usage,
                            move |request| {
                                let before = super::super::super::svg::svg_bitmap_cache_usage()
                                    .resident_bytes();
                                trim.request(request.target_bytes);
                                lgui_core::memory::TrimResult {
                                    before_bytes: before,
        ...
        #[cfg(feature = "images-win32")]
        crate::register_image_repaint_hwnd(hwnd);
        #[cfg(feature = "store")]
        ...
        lgui_core::backend::install_window_commands(&manager, move |command| {
