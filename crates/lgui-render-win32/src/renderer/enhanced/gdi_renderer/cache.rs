...
thread_local! {
    pub(super) static OVERLAY_CACHE: RefCell<lgui_core::memory::LruCache<OverlayCacheKey, Vec<u8>>> = RefCell::new(
    ...
    pub(super) static GDI_FONT_FAMILY_CACHE: RefCell<lgui_core::memory::LruCache<(char, i32, i32), usize>> = RefCell::new(
        lgui_core::memory::LruCache::new(
            0,
            lgui_core::memory::ResourceClass::Cache,
...
fn gdi_telemetry(index: usize) -> &'static lgui_core::memory::CacheTelemetry {
    static TELEMETRY: std::sync::OnceLock<[lgui_core::memory::CacheTelemetry; 4]> =
...
pub(crate) fn gdi_renderer_cache_usage() -> lgui_core::memory::CacheUsage {
...
pub(super) struct GdiCompositingLayer {
    ...
    pub(super) shadow: Option<lgui_core::core::ShadowStyle>,
...
impl GdiBitmapCache {
    ...
    fn publish(&self) {
        gdi_telemetry(1).publish(lgui_core::memory::CacheUsage {
