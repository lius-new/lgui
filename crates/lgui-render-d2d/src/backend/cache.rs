...
pub(super) struct D2dBitmapCacheEntry {
    ...
    pub(super) retention: lgui_core::memory::RetentionClass,
    pub(super) priority: lgui_core::memory::CachePriority,
}
...
pub(super) fn bitmap_cache_eviction_plan(
    entries: impl IntoIterator<
        Item = (
            D2dBitmapCacheKey,
            lgui_core::memory::RetentionClass,
            lgui_core::memory::CachePriority,
            u64,
            usize,
        ),
    >,
