...
#[derive(Clone)]
pub(super) struct ErasedRouteHandle {
    pub type_id: TypeId,
...
pub struct RouteId(pub(super) u64);

impl RouteId {
    pub(super) const UNASSIGNED: Self = Self(0);
...
pub struct RouteMatches {
    ...
    pub(super) entries: Vec<RouteMatch>,
}
