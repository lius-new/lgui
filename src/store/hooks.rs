...
mod tests {
    ...
    use crate::core::{
        component, content_text, context_provider, HostTreeBuilder, RenderCx, RootComponent,
        UiRect, UiRuntime, UiScale,
    };
        ...
        fn render_root(self, _cx: &mut RenderCx<'_, '_>) -> crate::core::Element {
            context_provider(
                ...
                component((), move |cx, _| {
                    ...
                    *self.action.lock().expect("counter action poisoned") =
                        Some(INCREMENT.bind(cx));
